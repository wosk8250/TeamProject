      ...
      <div class="card-body p-0">
        ...
        <div class="row" id="insert">
          <div class="col-lg-5 d-none d-lg-block">
	          <div>
	          	<img alt="join_img" src="/resources/image/insertBusiness.svg" id="joinImg" width="200" height="200">
	          </div>
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">사업자용 회원가입</h1>
              </div>
              <form class="user" id="insertUserPost" action="/user/insertBusiness" method="post">
